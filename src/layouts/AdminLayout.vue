<template>
  <el-container class="h-screen">
    ...
    <el-container>
      <el-header class="!h-14 flex items-center justify-between border-b border-gray-200 bg-white px-6">
        <h1 class="text-base font-semibold text-gray-800">{{ currentTitle }}</h1>
