        ...
        <div class="flex justify-center gap-4">
          <div class="text-center">
            <div class="w-40 h-40 rounded-xl overflow-hidden mb-2 border border-gray-100">
              <img :src="QR_CODES[0]" class="w-full h-full object-cover cursor-zoom-in" alt="微信赞助" @click="ui.openPreview(QR_CODES, 0)" />
            </div>
            <div class="text-sm text-gray-600">微信赞助</div>
          </div>
          <div class="text-center">
            <div class="w-40 h-40 rounded-xl overflow-hidden mb-2 border border-gray-100">
              <img :src="QR_CODES[1]" class="w-full h-full object-cover cursor-zoom-in" alt="支付宝赞助" @click="ui.openPreview(QR_CODES, 1)" />
            </div>
